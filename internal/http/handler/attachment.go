...
type AttachmentHandler struct {
	attachments attachment.UseCase
}

func NewAttachmentHandler(uc attachment.UseCase) *AttachmentHandler {
...
func (h *AttachmentHandler) List(c *gin.Context) {
	resp, err := h.attachments.List(c.Request.Context(), currentUserID(c), c.Param("id"), c.Param("taskId"))
	if err != nil {
		respondError(c, err)
		return
	}
...
func (h *AttachmentHandler) Download(c *gin.Context) {
	resp, rc, err := h.attachments.Download(c.Request.Context(), currentUserID(c), c.Param("id"), c.Param("taskId"), c.Param("attachmentId"))
	if err != nil {
		respondError(c, err)
		return
	}
...
func (h *AttachmentHandler) Delete(c *gin.Context) {
	if err := h.attachments.Delete(c.Request.Context(), currentUserID(c), c.Param("id"), c.Param("taskId"), c.Param("attachmentId")); err != nil {
		respondError(c, err)
		return
	}
